...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    /**里层滑动 外边的两个tavleview都不许动*/
    [[NSNotificationCenter defaultCenter] postNotificationName:@"me" object:nil];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    //劳资不动了你们继续嗨
    [[NSNotificationCenter defaultCenter] postNotificationName:@"you" object:nil];
